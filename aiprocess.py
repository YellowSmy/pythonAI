...
def _ai_process(trust):
    ...
    if(prediction[0,0] > prediction[0,1] or prediction[0,2]):
        ...
        if(confidence < trust):
            indicate = '몰?루'
            reason = '칩수율이 증가할 것으로 예측되나 정확도가 ' + str(trust) + '% 미만입니다.'
        ...
        indicate = '위험'
        reason = '수율이 증가하지 않습니다. 주의하세요!'

        if(confidence < trust):
            indicate = '몰?루'
            reason = '수율이 증가하지 않을 것으로 예측되나 정확도가 ' + str(trust) + '% 미만입니다.'
        ...
        if(confidence < trust):
            indicate = '몰?루'
            reason = '수율이 유지할 것으로 예측되나 정확도가 ' + str(trust) + '% 미만입니다.'
